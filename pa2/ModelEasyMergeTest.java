...
class ModelEasyMergeTest {
  ...
  public static void main(String args[]) {
    ...
    // do the following to show the main script that this compiled
    // this simply empties a file
    try {
      PrintWriter out = new PrintWriter(new FileWriter("EasyMergeTestsWork.txt"));
      out.close();
